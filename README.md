...
The display is showing data from the BMP-180 pressure sensor. Top left is temperature in degrees Fahrenheit, top right is pressure in Pascals, bottom left is elevation in feet and bottom right in meters. This is a very convenient way to display numerical data. It's not as much information as can be displayed on a 16 x 2 LCD or 48 x 84 Nokia 5110 LCD display, both of which I use and love, but it only requires four wires compared to the seven or eight for the other displays. And of course, the bubble display is way retro cooler, too!
